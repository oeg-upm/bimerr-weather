...
if [ $num_args -le 1 ]; then
	...
	echo curl --location --request POST "'"'http://127.0.0.1:5000/'"'" --header "'"'Content-Type: multipart/form-data; boundary=--------------------------554657334890040702125867'"'" --form "'"'data={'"$json"'}'"'" --form "'""$data""'" --output WidocoDocs.zip
